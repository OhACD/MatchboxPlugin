...
This folder contains user-facing and contributor documentation for the Matchbox plugin.
...
The `wiki-pages/` directory in the repository root contains wiki-ready versions of these documents, formatted for the GitHub Wiki. See `WIKI.md` in the repository root for wiki setup instructions.
...
- **Discord**: https://discord.gg/BTDP3APfq8
- **Modrinth**: https://modrinth.com/plugin/matchboxplugin
- **GitHub Repository**: https://github.com/OhACD/MatchboxPlugin
...
**Questions?** Join our [Discord](https://discord.gg/BTDP3APfq8) or check the [GitHub Issues](https://github.com/OhACD/MatchboxPlugin/issues).
